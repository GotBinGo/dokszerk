...
Google Chrome\index{Chrome}-ot kell beszereznünk, ha még nem tettük. Ez tehát a
felhasználói oldal.
...
Chrome\index{Chrome} V8 \gls{javascript} motorjára épül, amely már évek óta a legjobban
...
A WebSocket\index{WebSocket} \cite{3} technológia használható gyors kétirányú adatküldésre. A
...
A WebSocket\index{WebSocket} szerver megadott \acrshort{tcp} porton hallgat és várja a
...
\subsubsection{HTML5 \Gls{canvas}}
...
Google Chrome\index{Chrome}-ot is használok. Így biztosítani tudom, hogy mindkét
...
böngésző által támogatott WebSocket\index{WebSocket}-re esett. Ez viszont nem minden. A
...
C:\textbackslash{}Program Files (x86\index{x86})\textbackslash{}nodejs mappában
